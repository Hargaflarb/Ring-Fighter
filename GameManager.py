...
class Game_manager():
    ...
    def Start_game(self,character):
        ...
        self._match_datas.append(Match_data(self._game_world, "some type", character,"Echo", "Medium"))
        self._match_datas.append(Match_data(self._game_world, "some type", character,"Emma", "Easy"))
