...
class Game_World:
    ...
    def Add_SFX(self):
        ...
        # sm.Add_sfx("EchoDS","Echo\\Echo down smash.mp3",0.5)
        # sm.Add_sfx("EchoLA","Echo\\Echo low attack.mp3",0.5)
        # #sm.Add_sfx("EchoUS","Echo\\Echo up smash.mp3",0.5)
        # sm.Add_sfx("EchoSA","Echo\\Echo standard attack.mp3",0.5)
        # sm.Add_sfx("EchoR","Echo\\Echo ranged.mp3",0.5)
        # sm.Add_sfx("EchoF","Echo\\Echo fall.mp3",0.5)
        # sm.Add_sfx("EchoH","Echo\\Echo hit 1.mp3",0.5)
        # #sm.Add_sfx("EchoH","Echo\\Echo hit 2.mp3",0.5)
        # sm.Add_sfx("EchoT1","Echo\\Echo taunt 1.mp3",0.5)
        # sm.Add_sfx("EchoT2","Echo\\Echo taunt 2.mp3",0.5)
