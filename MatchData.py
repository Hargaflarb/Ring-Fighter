...
class Match_data():
    ...
    def Create_characters(self):
        ...
        characters.append(Player(self._game_world, pygame.math.Vector2(480, 360), 0.75, 1, self._player_type))
        characters.append(Enemy(self._game_world, pygame.math.Vector2(800, 360), 0.75, -1, characters[0], self._enemy_type))
